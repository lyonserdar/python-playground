...
# Calculates the exact time between two dates
...
# Calculates the number of days unit the end of the year
today = datetime.date.today()
end_of_year = datetime.date(today.year, 12, 31)
diff = (end_of_year - today).days
print(f"Number of days until the end of the year: {diff}")

# Calculates the exact time remaining until the end of the year
